...
class TaskManager:
    def __init__(self, addresses, sourcetype:define.Config, chain_id, proxies, rate, capacity, max_threads_per_proxy):
      ...
      #  self.proxy_pool.add_proxy()
        ...
        self.progress_bar = tqdm(total=self.total_tasks, desc="Total Progress")
