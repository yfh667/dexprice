...
def pairaddressdb(chain_id,pair_addresses,num_threads,proxy_ports,rate,capacity,process_fn):
...
if __name__ == "__main__":
    ...
    chain_id = "ethereum"
    pair_addresses = ["1", "0x5c6919B79FAC1C3555675ae59A9ac2484f3972F5", "0xE2c456b849bE4cD14D8422D9868953Ac60633E0d"]  # 示例地址
    ...
    # results = pairaddressdb(chain_id,pair_addresses,num_threads,proxy_ports,rate,capacity,tokenflitter.eth_big)
    # print(results)
    # # 验证每个元素
    ...
    for results1 in flattened_results:
        if tokenflitter.eth_big(results1):
            #   print(results1)
            tokens.append(results1)
            print("yes")
        else:
