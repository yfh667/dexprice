...
class TokenInfo:
    def __init__(self, address: str,name: str, price_usd: float, liquidity_usd: float, fdv: float, timestamp: str,creattime: str ,pair_address: str):
    ...
    def __repr__(self):
        return f"TokenInfo(address={self.address}, name={self.name}, price_usd={self.price_usd}, liquidity_usd={self.liquidity_usd}, fdv={self.fdv}, timestamp={self.timestamp}, pair_address={self.pair_address}, creattime={self.creattime})"
