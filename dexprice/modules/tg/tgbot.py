...
def send_message(token, chat_id, text,port):
    """
...
def sendmessagewithtoken(address,chat_id):# "@jingou11"
    escaped_text = escape_markdown(address)
    ...
    token = "7190422738:AAEuhELn2QcVfEDa-cF4bAwe4KgyQmbNF_Q"
    send_message(token, chat_id, message_content)
